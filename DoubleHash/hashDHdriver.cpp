...
int main() {
    ...
    for(int i = 0; i < 50; i++) { 
        ...
        for(int j = 0; j < 200; j++) { // Insert 200 items
        ...
        for(int j = 0; j < 200; j++) { // Searching for 200 item based on random know indexs
    ...
    //out_file << "DoubleHash Insert:" << endl; // Insert
    for(int i = 0; i < 50; i++) {
        out_file << insert[i] << ',' << insertCol[i] << endl;
    }

    out_file << endl;
    //out_file << "DoubleHash Search:" << endl; // Search
    for(int i = 0; i < 50; i++) {
