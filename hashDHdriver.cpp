...
int main() {
    ...
    out_file << "DoubleHash Insert:" << endl;
    for(int i = 0; i < 50; i++) {
        out_file << "Time: " << insert[i] << " Collisions: " << insertCol[i] << endl;
    }
    ...
    arrIndex = 0;
    for(int i = 0; i < 50; i++) { // Searching Hash table with BST chaining
        float totalTime = 0;
        int colStart = hashTable.getNumOfCollision();
    ...
    out_file << "DoubleHash Search:" << endl;
    for(int i = 0; i < 50; i++) {
        out_file << "Time: " << search[i] << " Collisions: " << searchCol[i] << endl;
    }
